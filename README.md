...
- Inherit from the `BaseWorkflow` and `BaseState` classes. For more details, refer to the [Simple Chat Workflow](./graph_workflow/workflows/simple_chat.py) example.
- Place your workflow in the `graph_workflow/workflows` module.
